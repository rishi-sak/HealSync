...
public class DashboardServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("missedDoses", missedDoses); // today's only
        request.setAttribute("doseHistory", doseHistory); // all-time history
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String action = request.getParameter("action"); // "TAKEN" or "SKIPPED"
        ...
        if (action != null && medicineName != null && medTime != null) {
            try {
                ...
                // ✅ Prevent overwriting TAKEN/SKIPPED status
                ...
                if (rs.next()) {
                    ...
                    if ("TAKEN".equals(existingStatus)) {
                        canUpdate = false; // ✅ do not overwrite
                    }
                }
                ...
                if (canUpdate) {
                    ...
                    ps.setString(3, medTime + ":00"); // ensure TIME format
