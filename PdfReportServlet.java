...
public class PdfReportServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            // Initialize PDF writer before DB calls
            ...
            // Get user name
            String userName = "";
            PreparedStatement psUser = conn.prepareStatement("SELECT name AS username FROM users WHERE id = ?");
            ...
            e.printStackTrace(); // log to console, not response
            try {
                if (document.isOpen()) {
